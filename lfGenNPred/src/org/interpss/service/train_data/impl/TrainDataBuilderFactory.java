...
import org.interpss.service.train_data.singleNet.aclf.load_change.VThCaseBuilder;
...
public class TrainDataBuilderFactory {
	...
	public static ITrainCaseBuilder createTrainCaseBuilder(String builderName) {
		if (builderName.equals("VThCaseBuilder"))
			return new VThCaseBuilder();
		else if (builderName.equals("BranchPLoadChangeTrainCaseBuilder"))
